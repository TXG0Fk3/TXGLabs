# Application.py
#
# Copyright 2024 LW Tech Corporation
#
...
class Application(Adw.Application):
    ...
    def __init__(self):
        super().__init__(application_id='corp.lwtech.LwUtils',
                         flags=Gio.ApplicationFlags.DEFAULT_FLAGS)

    def do_activate(self):
        win = self.props.active_window
        if not win:
            win = ApplicationWindow(application=self, title='LwUtils', icon_name=self.application_id)
        win.present()


@Gtk.Template(resource_path='/corp/lwtech/LwUtils/ui/main_window.ui')
class ApplicationWindow(Adw.ApplicationWindow):
    ...
    def on_about_menu_clicked(self, _action, _param):
        builder = Gtk.Builder.new_from_resource('/corp/lwtech/LwUtils/ui/about_window.ui')
    ...
    def on_shortcuts_menu_clicked(self, _action, _param):
        builder = Gtk.Builder()
        builder.add_from_resource('/corp/lwtech/LwUtils/ui/shortcuts_overview.ui')
